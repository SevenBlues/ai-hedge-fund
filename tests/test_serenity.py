...
from src.serenity.chokepoint_data import by_ticker, get_universe
from src.serenity.scoring import WEIGHTS, rank, score_node, score_universe
...
def test_monte_carlo_is_deterministic():
    from src.serenity.adversarial import monte_carlo
...
def test_llm_redteam_degrades_gracefully():
    ...
    from src.serenity.adversarial import llm_redteam
...
def test_live_no_listing_is_not_ok():
    from src.serenity.live_data import fetch_live_quote
...
def test_enrich_node_preserves_structural_fields():
    from src.serenity.live_data import LiveQuote, enrich_node
...
def test_pool_respects_certainty_gate():
    from src.serenity.pool import MIN_CHOKEPOINT, MIN_PROB_POSITIVE_EV, MIN_WIN_PROB, select_pool
...
def test_oos_pure_helpers():
    from src.serenity.oos_backtest import _ann
    from src.serenity.backtest import _stats
...
def test_exp_return_monotonic_in_winprob():
    from src.serenity.pool import _exp_return
